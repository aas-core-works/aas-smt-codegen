...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "aas_smt_codegen").glob("**/*.py"):
    ...
    if (
        ...
        print(
            "Checking that aas_smt_codegen/__init__.py and pyproject.toml "
            "are consistent..."
        )
        exit_code = call_and_report(
            verb=(
                "check that aas_smt_codegen/__init__.py and pyproject.toml "
                "are consistent"
            ),
            cmd=[
                sys.executable,
        ...
        print(
            "Skipped checking that aas_smt_codegen/__init__.py and "
