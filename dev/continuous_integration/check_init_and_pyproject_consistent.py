...
def main() -> None:
    ...
    metadata = cast(PackageMetadata, importlib.metadata.metadata("aas-smt-codegen"))

    # Check version
    init_version = aas_smt_codegen.__version__
    ...
    # Check authors
    init_authors = [author.strip() for author in aas_smt_codegen.__author__.split(",")]
    ...
    init_status = aas_smt_codegen.__status__
    ...
    # Check license
    init_license = aas_smt_codegen.__license__
